...
Today the Linked Open Data and the Semantic Web provide the technical solutions for the integration of distributed data, their interrogation and their interpretation. These technologies allow reasoning through knowledge, especially in the form of ontologies, classifications or medical thesauri. Essential knowledge in pharmacoepidemiology, drug interactions, indications and contraindications has thus been taken into account in clinical data analyzes [2]. However, while works like the Drug Indication Database (DID) and Drug Interaction Knowledge Base (DIKB) have pooled different sources of medical knowledge from the Web of Data [3, 4], the use and merging of knowledge is still well-to-do with the multitude of medical classifications and sources of knowledge.

We propose a tool to integrate ontologies programmatically in the R environment. The queryMed package provides pharmacoepidemiologists and public health researchers with functions and algorithm to query the different sources of medical knowledge representations from the Web of data and to link them to the main medical classifications, for the enrichment of the analysis of clinical and clinical data.
...
\bibitem[Kurbatova {\it et~al}., 2011]{Kurbatova11} Kurbatova, N. , Adamusiak, T., Kurnosov, P., Swertz, MA., Kapushesky, M. ontoCAT: an R package for ontology traversal and search, {\it Bioinformatics}, {\bf 27}(17), 2468–2470.