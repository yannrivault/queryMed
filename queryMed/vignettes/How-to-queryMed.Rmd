...
For instance, DB-pedia[ref] and Bio2rdf[ref] contain lot of informations about drugs. Quering their SPARQL endpoints can allow retrieving definitions, formulas, labels, comments about drugs, on also mappings between drugs nomenclatures.

Medical informations from ontologies are also available through REST API. For instance, the REST api from BIOPORTAL, allows us to retrieve mappings between main international medical nomenclatures via concept unique identifier (cui).
